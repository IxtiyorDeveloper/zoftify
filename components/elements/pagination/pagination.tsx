                ...
                <div>
                    <nav className="relative z-0 inline-flex -space-x-px rounded-md" aria-label="Pagination">
                        ...
                        >
                            ...
                            <ChevronLeftIcon className="h-5 w-5 text-color-1" aria-hidden="true"/>
                        </div>
                        {
                            arr?.map((i, k) => {
                                return (
                                    <div
                                        key={k}
                                        aria-current="page"
                                        className={`relative z-10 inline-flex rounded cursor-pointer items-center ${page === i ? "bg-pr" : "text-color-1"} px-4 py-2 text-sm font-medium text-white`}
                                        onClick={() => setPage(i)}
                                    >
                                        {i}
                                    </div>
                        ...
                        >
                            ...
                            <ChevronRightIcon className="h-5 w-5 text-color-1" aria-hidden="true"/>
                        </div>
                    </nav>
                </div>
            </div>
